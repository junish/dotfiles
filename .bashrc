...
alias kblight_off="su -c 'echo 0 > /sys/devices/platform/applesmc.768/leds/smc\:\:kbd_backlight/brightness'"
alias kblight_on="su -c 'echo 255 > /sys/devices/platform/applesmc.768/leds/smc\:\:kbd_backlight/brightness'"
